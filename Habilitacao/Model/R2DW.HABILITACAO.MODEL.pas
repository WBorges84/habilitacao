  ...
  try
    ...
    qryS.ExecSQL;
     ...
     //---- PERGUNTA 2  ----//
         ...
         //VERIFICA SE PERGUNTA Já ESTA ADICIONADA
...
begin
  ...
  try
         ...
         y := y + 1;
          ...
          begin
            ...
            erros := erros + 1 ;
             ...
             try
              // SALVA AS QUESTÕES ERRADAS


              //VERIFICA SE JÁ TEM CADASTRADA
    ...
    if aprovado > 20 then
    begin
      PageProva.lblAprovado.Text := 'Parabéns você foi aprovado';

    end
    else
    begin
      PageProva.lblAprovado.Text := 'Você foi Reprovado';

    end;

    PageProva.lblAcertos.Text := 'Você obteve: ' + acertos.ToString + ' Acertos';
    PageProva.lblErros.Text := 'Você obteve: ' + erros.ToString + ' Erros';
    acertos := 0;
    erros := 0;
